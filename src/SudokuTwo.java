public class SudokuTwo {
    public static void main(String[] args) {
        int[][] numbers = {{1, -1, 3, 4}, {-1, 1, 2, 4}, {2, 3, -1, 4}};
        ...
        // b. jak ją znajdziemy to wtedy zaczynamy obliczać jaka wartośc należy wstawić => suma 10, od 10 odejmujemy kolejne wartości w danym wierszu o ile różna od -1;
